    ...
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
          {"Master Job Interview with AI-Powered Practice Session"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        >
          Our AI mock interview platform provides realistic, personalized practice tailored to any job description. Get instant feedback on your answers, build confidence, and walk into your next interview prepared for success.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
